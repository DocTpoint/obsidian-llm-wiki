...
> **Status.** v1.26.3 PATCH ready-to-tag. 5/5 PRs merged on `main` (HEAD `b14929ef`): #447 / #448 / #453 / #450 / #454. Release workflow pending — version bump → pre-release-gate + doc-review → Obsidian Bot pre-review → publish. Composition: see [ROADMAP v1.26.x PATCH track](./ROADMAP.md).
