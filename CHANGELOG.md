...
> **Status.** Work in progress for the next PATCH (target v1.26.1). Everything below except the *Tracked* and *Planned* sections is merged on `main` since v1.26.0 (tag 2026-08-06) but not yet in a tagged release. Version bump + tag pending maintainer approval. Composition: see [ROADMAP v1.26.x PATCH](./ROADMAP.md#v126x-patch-target-v1261--roi-ranked).
