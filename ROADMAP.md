...
**v1.26.4 release plan:** 6 items. **MERGED 2026-08-16: #456 (PR #462), #451 (PR #465), #463 (PR #476).** #449 = PR #464 in review (DocTpoint). #474 = three-layer output-robustness fix in design. #473 = input-token-budget fix in design. Simplify + code-review on combined diff, release-skill v1.7.1 Step 5b.5 Bot pre-review BEFORE tag. Target ship date 2026-08-21 (7 days).

**Test count delta:** +22 (#460) + ~110-160 (#456 + #449 + #451) + 8 (#463) + ~80-120 (#474 + #473) ≈ 3290 → ~3560-3700.
