export const PT_TEXTS = {
    ...
    lintDedupJaccardBodyGateDesc: 'Quão semelhantes devem ser os textos de duas páginas (como fração) para serem sinalizadas como duplicadas quando compartilham links wiki. Páginas cuja similaridade do corpo é inferior a este valor não são sinalizadas como duplicadas, mesmo com grafos de links idênticos. Aumente este valor se vir falsos positivos em que duas páginas não relacionadas apontam para o mesmo hub. Deixe em branco para usar o padrão.',
