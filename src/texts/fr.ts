export const FR_TEXTS = {
    ...
    lintDedupJaccardBodyGateDesc: 'À quel point les textes de deux pages doivent être similaires (en fraction) pour être signalées comme doublons lorsqu\'elles partagent des liens wiki. Les pages dont la similarité du corps est inférieure à cette valeur ne sont pas signalées comme doublons, même avec des graphes de liens identiques. Augmentez ce seuil si vous voyez des faux positifs où deux pages sans rapport pointent vers le même centre. Laissez vide pour utiliser la valeur par défaut.',
